    ...
    return (
        <div key="homePage" className="homeBackground">
            ...
            <div id="aboutUs"  className="homeContainer">
                ...
                <p className="description">Дорогие Господа!<br/>
...
На ваше усмотрение будут представлены рестораны, испытанные самыми избалованными гостями, пережившие самые  тщательные проверки и отвоевавшие тем самым звания лучших заведений города с высокой кухней.<br/>
